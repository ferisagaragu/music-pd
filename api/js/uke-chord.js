    ...
    class UkeChord extends HTMLElement {
      connectedCallback() {
        ...
        const svg = `
          <svg id="ukeChordSvg" width="90" height="112" viewBox="0 0 90 112"
            ...
            <text id="chordName" x="48" y="16" text-anchor="middle" style="font-size: 16px;" fill="${this.titlecolor}"></text>
            <g id="svgChord" transform="translate(19,12)">
              <text id="position" x="-14" y="17" text-anchor="middle" fill="${this.titlecolor}"></text>
              <rect id="nut" height="4" width="62" fill="${this.nut}" style="visibility: hidden;"/>
              ...
              <g id="strings" transform="translate(0,2)">
                <rect height="80" width="2" x="0"  fill="${this.sheet}"/>
                <rect height="80" width="2" x="20" fill="${this.sheet}"/>
                <rect height="80" width="2" x="40" fill="${this.sheet}"/>
                <rect height="80" width="2" x="60" fill="${this.sheet}"/>
              </g>
              <g id="frets" transform="translate(0,2)">
                <rect height="2" width="62" y="0"  fill="${this.sheet}"/>
                <rect height="2" width="62" y="20" fill="${this.sheet}"/>
                <rect height="2" width="62" y="40" fill="${this.sheet}"/>
                <rect height="2" width="62" y="60" fill="${this.sheet}"/>
                <rect height="2" width="62" y="80" fill="${this.sheet}"/>
              </g>
              <g id="closedStrings" transform="translate(1,13)">
                <g id=closedString0 style="visibility: hidden;">
                  <circle r="6" fill="${this.finger1circlecolor}"/>
                  <text fill="${this.finger1textcolor}" id="finger0" y="4" text-anchor="middle"></text>
                </g>
                <g id="closedString1" style="visibility: hidden;">
                  <circle r="6" fill="${this.finger2circlecolor}"/>
                  <text fill="${this.finger2textcolor}" id="finger1" y="4" text-anchor="middle"></text>
                </g>
                <g id="closedString2" style="visibility: hidden;">
                  <circle r="6" fill="${this.finger3circlecolor}"/>
                  <text fill="${this.finger3textcolor}" id="finger2" y="4" text-anchor="middle"></text>
                </g>
                <g id="closedString3" style="visibility: hidden;">
                  <circle r="6" fill="${this.finger4circlecolor}"/>
                  <text fill="${this.finger4textcolor}" id="finger3" y="4" text-anchor="middle"></text>
                </g>
              </g>
              <g id="openStrings" transform="translate(1,-5)">
                <circle id="openString0" cx="0"  r="4" fill="none" stroke="${this.upsymbol}" stroke-width="1" style="visibility: hidden;"/>
                <circle id="openString1" cx="20" r="4" fill="none" stroke="${this.upsymbol}" stroke-width="1" style="visibility: hidden;"/>
                <circle id="openString2" cx="40" r="4" fill="none" stroke="${this.upsymbol}" stroke-width="1" style="visibility: hidden;"/>
                <circle id="openString3" cx="60" r="4" fill="none" stroke="${this.upsymbol}" stroke-width="1" style="visibility: hidden;"/>
              </g>
              <g id="subText" transform="translate(1,98)">
                <text id="subText0" x="0" text-anchor="middle" fill="${this.endtext}"></text>
                <text id="subText1" x="20" text-anchor="middle" fill="${this.endtext}"></text>
                <text id="subText2" x="40" text-anchor="middle" fill="${this.endtext}"></text>
                <text id="subText3" x="60" text-anchor="middle" fill="${this.endtext}"></text>
              </g>
            </g>
          </svg>`;
      ...
      setSize() {
        ...
        if (this.size === "M" || this.size === "m") {
          this.$.ukeChordSvg.setAttribute("width", 90);
          if (this.name) {
            this.$.ukeChordSvg.setAttribute("height", 134);
          } else {
            this.$.ukeChordSvg.setAttribute("height", 112);
          }
        }
      }
